...
public class GuDingZiChanFkdFromWorkerFlowEvent extends AbstractWorkflowEvent{
	private static final Log log = LogFactory.getLog(GuDingZiChanFkdFromWorkerFlowEvent.class);
	private static String gudingzichanfkd = AppContext.getSystemProperty("Information.ncctwo.gudingzichanfkd");
	private static String gudingzichanfkdresult = AppContext.getSystemProperty("Information.ncctwo.gudingzichanfkdresult");
    ...
    public WorkflowEventResult onBeforeFinishWorkitem(WorkflowEventData data) {
    	...
    	SAVELOG("固定资产付款单的处理前事件---AffairId:" + data.getAffairId() + "_FormApp:" + data.getFormApp() + "_SummaryId:" + data.getSummaryId());
	...
	public Integer changeform(WorkflowEventData data, String content) {
        ...
        try {
            ...
            String updatesql = "update "+gudingzichanfkd+" set "+gudingzichanfkdresult+" = ? where id = ?";
    ...
    private String useinterface(WorkflowEventData data) {
      ...
      //<!-- 贷方分录   -->
        ...
        writexmldoc.append("<pk_currtype>").append("CNY").append("</pk_currtype>");//<!-- 币种 非空-->
        writexmldoc.append("<pk_accasoa>").append(100201).append("</pk_accasoa>");//<!-- 科目 非空-->
        ...
        writexmldoc.append("<ass>");
            ...
            writexmldoc.append("<pk_Checkvalue>").append("CF2002").append("</pk_Checkvalue>");  // 辅助核算值 档案转换
            writexmldoc.append("</item>");
            // 客商
            writexmldoc.append("<item>");
            writexmldoc.append("<pk_Checktype>").append("0004").append("</pk_Checktype>"); // 辅助核算类型 (会计科目辅助核算)
